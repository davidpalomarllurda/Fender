...
6- From the command line navigate to the path where the file for this exercises are stored, then run Fender_Smoke_Tests.py then you will see the unit test results on the console.
